...
public class UsuariosDAO {
    ...
    public boolean editar(Usuarios usuario, Connection con) throws SQLException{
        String sql = "UPDATE USUARIO SET nombre = ?, apellido = ?, email = ?, direccion = ? WHERE cedula = ?";
    ...
    public boolean agregar(Usuarios usuario) {
        String sql = "INSERT INTO USUARIO (CEDULA, NOMBRE, APELLIDO, EMAIL, LOGIN, CONTRASENA, DIRECCION) VALUES (?, ?, ?, ?, ?, ?, ?)";
